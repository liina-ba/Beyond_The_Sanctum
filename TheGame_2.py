...
def play_game2():
    ...
    font0_0 = pygame.font.Font("resources/fonts/times new roman italic.ttf", 25)
    ...
    text17_2 = "Thalos : “we are not with the Grimrushers”\n\nraventhorn : “why would we believe you”\n\nand before you say another word The guards tie you up"
    ...
    text38 = "Aiden decides to hide, monitoring the situation. As dawn breaks, the commotion subsides, and most Grimrushers return to their usual concerns. This land is bordered by wooden stakes, marking the boundary between civilization and the darkness of the surrounding forest. Security is not as strict as expected, with only a few Grimrushers lazily patrolling.\n\nApproaching the village, Aiden spots a group of guards patrolling near the entrance."
    text39 = "Using his mastery of light magic, he suddenly creates a dazzling explosion in the sky, temporarily blinding the Grimrushers.\n\nWhile they blink disoriented, Aiden skilfully throws a branch into the woods, creating a resounding noise that attracts their attention. As the guards rush to investigate, Aiden sneaks into the village unnoticed.\n\nMoving through the alleys without being caught, Aiden is astonished to discover that the Grimrushers live like humans, cultivating their own fruits and vegetables and favoring barter over money for trade. He sees their children laughing and running around. This observation challenges his perception of Grimrushers as enemies. Suddenly, Aiden remembers his mission, turning back.\n\nHe is approached by a huge Grimrusher dressed in nomadic attire, wearing a scarf on his head who reveals that he was searching for him and that he is on the same side as him."
    ...
    text41 = "you use your magic to temporarily deactivate the sensors, allowing you to safely cross the trap-ridden area.\n\nFinally, you reach a grand staircase leading to the upper floors of the castle. With increased caution, you ascend the steps. At the top of the stairs, you find themselves facing a large ornate door, guarded by two Grimrusher soldiers.\n\nAs you try to escape after being spotted by the soldiers, you quickly find yourself surrounded and captured by the royal guard. Despite your efforts to break free, you are quickly subdued and dragged to the throne room, where the Grimrusher king awaits you with a mocking smile.\n\nKing : “kneel down Aiden”"
    ...
    while True:
        ...
        button37_2.check_hover(mouse_pos)
        ...
        if done20_1:
            ...
            draw_line(screen, 130, HEIGHT - 390, WIDTH - 130, HEIGHT - 390, 1, (109, 69, 38), scroll_offset,  line_visible)
        ...
        if done25:
            ...
            draw_line(screen, 130, HEIGHT + 590, WIDTH - 130, HEIGHT + 590, 1, (109, 69, 38), scroll_offset, line_visible)
        ...
        if done29:
            ...
            display_text(screen, "the veroccusom extract and the shivereana extract ", (255, 326), font0, (255, 255, 255), scroll_offset)
            draw_line(screen, 130, HEIGHT + 280, WIDTH - 130, HEIGHT + 280, 1, (109, 69, 38), scroll_offset,   line_visible)
        ...
        if done39_2:
            ...
            draw_line(screen, 130, HEIGHT - 230, WIDTH - 130, HEIGHT - 230, 1, (109, 69, 38), scroll_offset, line_visible)
        ...
        if done39_4:
            ...
            draw_line(screen, 130, HEIGHT + 430, WIDTH - 130, HEIGHT + 430, 1, (109, 69, 38), scroll_offset,  line_visible)
        ...
        if done42_1:
            ...
            display_text(screen, "You give up, we thought you were stronger than that aiden.. game over", (250, 350), font, (255, 255, 255), scroll_offset)
        ...
        if done42_2:
            ...
            draw_line(screen, 130, HEIGHT - 315, WIDTH - 130, HEIGHT - 315, 1, (109, 69, 38), scroll_offset, line_visible)
